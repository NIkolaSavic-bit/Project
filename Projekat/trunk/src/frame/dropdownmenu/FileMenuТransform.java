...
public class FileMenuТransform extends JMenu {
	...
	public FileMenuТransform() {
		...
		Image conceptualIcon = toolkit.getImage("Projekat/trunk/src/Icons/ConceptualModel.png");
		...
		Image logicalIcon = toolkit.getImage("Projekat/trunk/src/Icons//LogicalModel.png");
		...
		Image scriptIcon = toolkit.getImage("Projekat/trunk/src/Icons//sql_icon.png");
